...
const Nav = ({ isOpen, onOpen, onClose }: NavProps): JSX.Element => {
  ...
  return (
    <Grid
      as="nav"
      px={['2rem', '2rem', '2rem', '0']}
      gridTemplateColumns={['1fr', '1fr', '2fr 4fr 1.5fr 0.5fr']}
      alignContent="center"
      justifyContent={['center', 'center', 'space-between']}
      margin="3rem 0"
    >
      <Container display={['none', 'none', 'flex']}>
        <NavLink href="/">Priyansh Shah</NavLink>
      </Container>
      ...
      <Container alignContent="flex-end" display={['none', 'none', 'flex']}>
        <NavLink href="pdf/Priyansh_Kalpesh_Shah_Resume.pdf" download="Priyansh_Kalpesh_Shah_Resume">Resume</NavLink>
      </Container>
      <Container alignContent="flex-end" display={['none', 'none', 'flex']}>
        <NavLink href="mailto:shahpriyansh598@gmail.com">Contact</NavLink>
      </Container>
    </Grid>
  );
};
