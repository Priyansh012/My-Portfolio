  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta charSet="utf-8" />
        <meta name="author" content="Priyansh Shah" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta property="og:title" content="Priyansh Shah" />
        <meta
          property="og:description"
          content="I'm a Full Stack developer with experience in Backend, Frontend, DevOps, and Desktop development."
        />
